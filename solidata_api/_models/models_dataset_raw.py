...
class Dsr_infos : 
	...
	def __init__(self, ns_) :
		...
		self.uses					= create_model_uses(		ns_,	model_name=model_type+"_uses", 			schema_list=[ "dsi" ])
		self.uses_light				= create_model_uses(		ns_,	model_name=model_type+"_uses", 			schema_list=[ "dsi" ])
