...
log.debug(">>> api_tags ... creating api endpoints for TAG")

from . import api, document_type

### create namespace
ns = Namespace('infos', description='Tags : request and list all tags infos')
...
class Tag_List(Resource):
	...
	def get(self):
		...
		>
			--- needs   : nothing - optionnal args : pagination, list of oid_tag, list of tags, query
			>>> returns : tag data as a list
